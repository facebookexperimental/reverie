...
| CPU-heavy | DBT | dynamic | 27,056.8 | 5,030.1 | 5.379x | 28,299 |
...
| Syscall-mix | DBT | dynamic | 27,638.6 | 5,036.4 | 5.488x | 450,750 |
...
The current DBT client is different: it instruments application branches in
...
SaBRe report one additional call; ptrace and DBT report 31-32 additional
